//This version contains the first automated version
...
class UserForm extends Component {
  ...
  state = {
    ...
    // password1: "",
    // password2: "",
    // formTest: ['firstName', 'username', 'email'],
    formTest: [
      ...
      { name: 'addressPostalcode', type: 'number' },
      { name: 'addressCity', type: 'text' },
      { name: 'addressPhone', type: 'text' },
      { name: 'copyAddress', type: 'checkbox' },
      { name: 'addressPostalcodeInvoice', type: 'number' },
      { name: 'addressCityInvoice', type: 'text' },
      { name: 'addressPhoneInvoice', type: 'text' }
    ],
    ...
    //   addressCity: 'text',
    //   addressPhone: 'tel',
    //   addressPostalcodeInvoice: 'number',
    //   addressCityInvoice: 'text',
    //   addressPhoneInvoice: 'tel0',
    //   copyAddress: 'checkbox'
    // },
